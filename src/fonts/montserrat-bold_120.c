 ...
 * Size: 120 px
 * Bpp: 4
 * Opts: --bpp 4 --size 120 --no-compress --stride 1 --align 1 --font Montserrat-Bold.ttf --range 1040 --format lvgl -o montserrat-bold 120.c
 ******************************************************************************/
...
#ifndef MONTSERRAT-BOLD 120
#define MONTSERRAT-BOLD 120 1
#endif

#if MONTSERRAT-BOLD 120
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1534, .box_w = 96, .box_h = 85, .ofs_x = 0, .ofs_y = 0}
};
...
extern const lv_font_t lv_font_Montserrat-Bold 120;
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t montserrat-bold 120 = {
#else
lv_font_t montserrat-bold 120 = {
#endif
    ...
    .fallback = &lv_font_Montserrat-Bold 120,
#endif
    .user_data = NULL,
};
